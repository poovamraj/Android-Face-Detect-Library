package com.poovam.face_capture.framework.base_activity
 ...
 * The base activity to which fragments are going to be added and [com.poovam.face_capture.capture_activity.CaptureActivity]
 * will be called from
 */
